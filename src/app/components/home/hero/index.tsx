...
import CanadaBadge from '../../shared/uk-badge'
          ...
          <div ref={ref} className='flex flex-col items-center gap-8'>
            ...
            <div className='relative flex flex-col text-center items-center gap-4'>
              <h1 className='leading-tight'>
                <TextGenerateEffect words="Your Success, Engineered in Canada" />
                <TextGenerateEffect
              ...
              <p className='max-w-2xl text-dark_black/60 dark:text-white/60'>
                HABB is a Canada-based digital engineering partner specialising in designing and building secure, scalable products — web, mobile, cloud and AI. With a focus on reliability, performance and rapid time-to-market, we deliver production-ready software solutions to clients worldwide.
              </p>
            </div>
