            ...
            <div className="relative w-full pt-28 pb-20">
                <div className="container">
                    ...
                    <div className="mt-10 bg-white dark:bg-dark_black p-8 rounded-2xl shadow-sm">
                        ...
                        <p className="mt-6 text-sm text-dark_black/60 dark:text-white/60">For the full legal text, please consult the complete Terms & Conditions or contact info@habb.ca for clarifications.</p>
                    </div>
                </div>
            </div>
        </section>
